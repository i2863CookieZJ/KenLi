...
public class HeadImageFileChooseDirAdapter extends BaseAdapter {
	List<FileModel> mFileModels;
	Context mContext;
	public HeadImageFileChooseDirAdapter(Context ctx){
		this.mContext = ctx;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_choose_headimage_file_dir, null);
