...
public class SearchFragment extends BaseFragment {
	...
	@GinInjectView(id = R.id.mSearchBox)
	private SearchBox searchBox;
	@GinInjectView(id = R.id.search_selecttype)
	private ImageView selectType;
	@GinInjectView(id = R.id.keywordsflow_framework)
	private KeywordsFlow keywordsFlow;
	private LinearLayout mSearchHeaderLayout;
	private TextView mSearchHeaderText;
	@GinInjectView(id = R.id.search_resultlist)
	private ListView mListView;
	private BaseAdapter mAdapter;
	@GinInjectView(id = R.id.search_cancel_btn)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View view = getCacheView(mInflater, R.layout.activity_search);
		return view;
	}
	...
	public void setupSearchActivity() {
		...
		// findViewById(R.id.keywordsflow_framework);
		...
		News.getHotword(15, getActivity(), new OnJsonArrayResultListener() {
			@Override
		...
		mSearchHeaderLayout = new LinearLayout(getActivity());
		mSearchHeaderLayout.setGravity(Gravity.CENTER);
		mSearchHeaderText = new TextView(getActivity());
	...
	protected void mOnSearchBoxClick() {
		...
		if (mSearchContent.length() < 1) {
			...
			News.searchArticleList(0, mSearchContent, mSearchType, getActivity(), new OnJsonObjectResultListener() {
				@Override
