...
public class ExpandButton extends TextView implements OnClickListener {
	...
	public static void bindView(View parent, int button, int view) {
		ExpandButton eb = (ExpandButton)parent.findViewById(button);
	...
	public interface OnClickListener {
		void onWillExpand(ExpandButton view);
		void onWillShrink(ExpandButton view);
	};
