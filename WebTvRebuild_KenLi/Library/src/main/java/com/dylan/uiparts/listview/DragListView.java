...
public class DragListView extends ListView implements OnScrollListener {
	...
	private final static int PULL_DRAG_MORE_PIXEL = 60;
	...
	private void initWithContext(Context context) {
		...
		mHeaderTipsView = (TextView) mHeaderView.findViewById(R.id.draglistview_header_tips);
	...
	public void startManualRefresh(){
		mScroller.startScroll(0, 0, 0, mHeaderViewHeight, 500);
		mHeaderView.setState(DragListViewHeader.STATE_REFRESHING);
		mScrollBack = SCROLLBACK_HEADER;
//		mHeaderView.setTop(top);
	...
	public void stopMannualRefresh(){
		mScroller.startScroll(0, 0, 0, -(mHeaderViewHeight), 500);
	...
	public TextView getHeaderTipsTextView(){
		return mHeaderTipsView;
	}
	public TextView getHeaderTimeTextView(){
