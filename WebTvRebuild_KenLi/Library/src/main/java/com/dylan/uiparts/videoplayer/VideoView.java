...
public class VideoView extends SurfaceView implements MediaPlayerControl {
	...
	public void setVideoScale(int width, int height, int marginTop, int marginBottom) {
		MarginLayoutParams lp = (MarginLayoutParams) getLayoutParams();
		lp.height = height;
		lp.width = width;
		lp.setMargins(lp.leftMargin, marginTop, lp.rightMargin, marginBottom);
		setLayoutParams(lp);
	}
	...
	private MediaPlayer.OnErrorListener mErrorListener =
			new MediaPlayer.OnErrorListener() {
				public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
					 ...
					 * something bad has happened. Only try and pop up the
					 * dialog if we're attached to a window. When we're going
					 * away and no longer have a window, don't bother showing
					 * the user an error.
					 */
					if(getWindowToken() != null) {
						 ...
						 * else { messageId = com.android.internal.R.string.
						 * VideoView_error_text_unknown; }
						 * 
						 * new AlertDialog.Builder(mContext)
						 * .setTitle(com.android
						 * .internal.R.string.VideoView_error_title)
						 * .setMessage(messageId)
						 * .setPositiveButton(com.android.
						 * internal.R.string.VideoView_error_button, new
						 * DialogInterface.OnClickListener() { public void
						 * onClick(DialogInterface dialog, int whichButton) { If
						 * we get here, there is no onError listener, so at
