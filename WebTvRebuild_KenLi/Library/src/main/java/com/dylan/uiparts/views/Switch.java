...
public class Switch extends CompoundButton
{
	...
	public Switch(Context context, AttributeSet attrs, int defStyle) {
		...
		this.switchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_switchMinWidth, 30);
		this.textColorUnChecked = a.getColor(R.styleable.Switch_colorUnChecked, 0xff808080);
		this.textColorChecked = a.getColor(R.styleable.Switch_colorChecked, 0xffffffff);
