package com.dylan.common.animation;
...
public class AnimationController {
	...
	public void show(final View view, long delayMillis) {
	...
	public void hide(final View view, long delayMillis) {
		new Handler().postDelayed(new Runnable() {
			@Override
			public void run() {
				view.setVisibility(View.GONE);
	...
	//TODO
	public void slideInUp(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 1, rela2, 0);
		baseIn(view, animation, durationMillis, delayMillis);
	}

	public void slideOutUp(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 0, rela2, -1);
		baseOut(view, animation, durationMillis, delayMillis);
	}
	
	public void slideInDown(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, -1, rela2, 0);
		baseIn(view, animation, durationMillis, delayMillis);
	}

	public void slideOutDown(View view, long durationMillis, long delayMillis) {
		TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 0, rela2, 1);
		baseOut(view, animation, durationMillis, delayMillis);
	}
