...
import com.higgses.griffin.annotation.app.bitmap.BitmapCacheListener;
import com.higgses.griffin.annotation.app.bitmap.BitmapCommonUtils;
import com.higgses.griffin.annotation.app.bitmap.BitmapDisplayConfig;
import com.higgses.griffin.annotation.app.bitmap.BitmapGlobalConfig;
import com.higgses.griffin.annotation.app.bitmap.callback.BitmapLoadCallBack;
...
import com.higgses.griffin.annotation.app.bitmap.core.AsyncDrawable;
import com.higgses.griffin.annotation.app.bitmap.core.BitmapSize;
import com.higgses.griffin.annotation.app.bitmap.download.Downloader;
import com.higgses.griffin.annotation.app.cache.FileNameGenerator;
import com.higgses.griffin.annotation.app.task.PriorityAsyncTask;
import com.higgses.griffin.annotation.app.task.PriorityExecutor;
import com.higgses.griffin.annotation.app.task.TaskHandler;
