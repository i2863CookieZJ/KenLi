 ...
 *******************************************************************************/
package com.higgses.griffin.imageloader.cache.disc;
...
public interface DiscCacheAware {
	 ...
	 */
	boolean save(String imageUri, InputStream imageStream, GinULo.CopyListener listener) throws IOException;
