...
import com.higgses.griffin.imageloader.core.imageaware.ImageViewAware;
import com.higgses.griffin.imageloader.core.imageaware.NonViewAware;
...
import com.higgses.griffin.imageloader.core.listener.SimpleImageLoadingListener;
import com.higgses.griffin.imageloader.utils.GinUImageSize;
import com.higgses.griffin.imageloader.utils.GinULog;
import com.higgses.griffin.imageloader.utils.GinUMemoryCache;
...
import com.higgses.griffin.imageloader.core.assist.FlushedInputStream;
...
public class ImageLoader
{
    ...
    public synchronized void init(ImageLoaderConfiguration configuration)
    {
        ...
        {
            GinULog.d(LOG_INIT_CONFIG);
            engine = new ImageLoaderEngine(configuration);
            this.configuration = configuration;
        }
        else
        {
            GinULog.w(WARNING_RE_INIT_CONFIG);
        }
    }
     ...
     *         which should display image
     * @param listener
     *         {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on
     ...
     *         which should display image
     * @param options
     *         {@linkplain DisplayImageOptions Options} for image
     ...
     *         from configuration} will be used.
     * @param listener
     *         {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options, ImageLoadingListener listener, ImageLoadingProgressListener progressListener)
    {
        ...
        ImageSize targetSize = GinUImageSize.defineTargetSizeForView(imageAware, configuration.getMaxImageSize());
        String memoryCacheKey = GinUMemoryCache.generateKey(uri, targetSize);
        ...
        {
            GinULog.d(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, memoryCacheKey);
     ...
     *
     * @param imageAware
     *         {@link ImageAware ImageAware} for
     ...
     *         pass <b>true</b> - to use {@link FlushedInputStream} for network downloads; <b>false</b>
     *         - otherwise.
     */
