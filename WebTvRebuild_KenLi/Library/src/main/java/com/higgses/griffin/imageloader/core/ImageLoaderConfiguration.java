...
import com.higgses.griffin.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.higgses.griffin.imageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration
{
    ...
    private ImageLoaderConfiguration(final Builder builder)
    {
        ...
        GinULog.writeDebugLogs(builder.writeLogs);
    }
    ...
    public static class Builder
    {
        ...
        public Builder taskExecutor(Executor executor)
        {
            ...
            {
                GinULog.w(WARNING_OVERLAP_EXECUTOR);
            }
        ...
        public Builder memoryCacheSize(int memoryCacheSize)
        {
            ...
            if (memoryCache != null)
            {
                GinULog.w(WARNING_OVERLAP_MEMORY_CACHE);
            }
        ...
        public Builder diskCacheSize(int maxCacheSize)
        {
            ...
            if (diskCache != null)
            {
                GinULog.w(WARNING_OVERLAP_DISK_CACHE_PARAMS);
            }
        ...
        public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator)
        {
            if (diskCache != null)
            {
                GinULog.w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR);
            }
         ...
         * {@link GinStorage#getCacheDirectory(android.content.Context)
         * GinUStorage.getCacheDirectory(Context)}.<br />
         * <br />
         ...
         * Consider {@link GinULog#disableLogging()} to disable
        ...
        private void initEmptyFieldsWithDefaultValues()
        {
            ...
            {
                memoryCache = new FuzzyKeyMemoryCache(memoryCache, GinUMemoryCache.createFuzzyKeyComparator());
            }
            if (downloader == null)
            {
