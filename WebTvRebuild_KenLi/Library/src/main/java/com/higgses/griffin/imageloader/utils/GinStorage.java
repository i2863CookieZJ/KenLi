 ...
 *******************************************************************************/
package com.higgses.griffin.imageloader.utils;
...
public final class GinStorage
{
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal)
    {
        ...
        if (appCacheDir == null)
        {
            ...
            GinULog.w("Can't define system cache directory! '%s' will be used.", cacheDirPath);
    ...
    private static File getExternalCacheDir(Context context)
    {
        ...
        if (!appCacheDir.exists())
        {
            ...
            {
                GinULog.w("Unable to create external cache directory");
                return null;
            }
            try
            {
            ...
            {
                GinULog.i("Can't create \".nomedia\" file in application external cache directory");
            }
        }
        return appCacheDir;
    }
    ...
    private static File getExternalFileDir(Context context)
    {
        ...
        if (!appFileDir.exists())
        {
            ...
            {
                GinULog.w("Unable to create external files directory");
                return null;
            }
            try
            {
